...
<template>
  <div class="min-h-screen bg-white overflow-x-hidden">
    ...
    <!-- Section Services -->
    <section class="services-section py-20 bg-gradient-to-b from-primary-50 to-white">
      <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div class="service-card group">
            <div class="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100 hover:border-secondary-200 transform hover:-translate-y-2">
              <div class="h-48 bg-gradient-to-br from-secondary-400 to-secondary-600 relative overflow-hidden">
          ...
          <div class="service-card group">
            <div class="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100 hover:border-primary-accent-200 transform hover:-translate-y-2">
              <div class="h-48 bg-gradient-to-br from-primary-accent-400 to-primary-accent-600 relative overflow-hidden">
                <div class="absolute inset-0 bg-black/10"></div>
                <div class="absolute bottom-4 left-6">
                  <div class="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center backdrop-blur-sm">
                    <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div class="service-card group">
            <div class="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100 hover:border-secondary-accent-200 transform hover:-translate-y-2">
              <div class="h-48 bg-gradient-to-br from-secondary-accent-400 to-secondary-accent-600 relative overflow-hidden">
                <div class="absolute inset-0 bg-black/10"></div>
                <div class="absolute bottom-4 left-6">
                  <div class="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center backdrop-blur-sm">
                    <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
    ...
    <section class="popular-routes py-20 bg-white">
      <div class="container mx-auto px-4">
        <div class="text-center mb-16">
          <h2 class="text-4xl font-montserrat font-bold text-primary-900 mb-4">
